...
namespace DotVVM.Framework.Hosting
{
    public class DotvvmPresenter : IDotvvmPresenter
    {
        ...
        {
            DotvvmViewBuilder = configuration.ServiceProvider.GetService<IDotvvmViewBuilder>();
        ...
        public async Task ProcessRequest(DotvvmRequestContext context)
        {
            ...
            if (failedAsUnauthorized)
            {
                ...
                await DotvvmErrorPageMiddleware.RenderErrorResponse(context.HttpContext, exception);
            }
        }
