...
namespace DotVVM.Framework
{
    public static class KnockoutHelper
    {
        ...
        public static void AddKnockoutDataBind(this IHtmlWriter writer, string name, DotvvmBindableControl control, DotvvmProperty property, Action nullBindingAction)
        {
        ...
        public static string GenerateClientPostBackScript(CommandBindingExpression expression, RenderContext context, DotvvmBindableControl control)
        {
            var uniqueControlId = "";
