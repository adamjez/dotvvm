namespace DotVVM.Framework.Resources
{
    ...
    internal class DothtmlTokenizerErrors
    {
            ...
            get
            {
                if (resourceMan == null)
                    lock (locker)
                        if (resourceMan == null)
                        {
                            resourceMan = new System.Resources.ResourceManager("DotVVM.Framework.Resources.DothtmlTokenizerErrors", typeof(DothtmlTokenizerErrors).GetTypeInfo().Assembly);
                        }
                return resourceMan;
            }
        }
