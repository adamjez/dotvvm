            ...
            get
            {
                if (resourceMan == null)
                    lock (locker)
                        if (resourceMan == null)
                        {
                            resourceMan = new System.Resources.ResourceManager("DotVVM.Framework.Resources.Parser_Dothtml", typeof(Parser_Dothtml).GetTypeInfo().Assembly);
                        }
                return resourceMan;
            }
        }
